...
class Scheduler(object):
    ...
    def ispatientavailable(self,patient,time):
        if patient.patient_calendar[CLASS_APPOINTMENT_INFO].has_key(time):
            return "The patient " + patient.patient_name +  " already has an appointment with Dr. " + patient.patient_calendar[CLASS_APPOINTMENT_INFO][time][CLASS_NAME] + "\n"
            return False
        else:
            return True
